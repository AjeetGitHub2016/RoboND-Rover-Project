...
# define the threshold for obstacle and object detection
...
def perception_step(Rover):
    ...
    threshed_obstacles = color_thresh_obstacle(warped)
    ...
    xpix_obstacle, ypix_obstacle = rover_coords(threshed_obstacles)
    ...
    rover_centric_pixel_dist, rover_centeric_angles = to_polar_coords(xpix_terrain, ypix_terrain)   
    Rover.nav_dists = rover_centric_pixel_distances
    Rover.nav_angles = rover_centric_angles 
